def main():
    ...
    #Read the image.
    img = cv2.imread(r"C:\Users\Nivetha\Desktop\test\car1.jpeg")
    ...
    cv2.imshow("Preprocess 1 - Grayscale Conversion", gray_img)        #Display gray image
    cv2.waitKey(0)
    ...
    cv2.imshow("Preprocess 2 - Bilateral Filter", gray_img)    #Display preprocessed image.
    cv2.waitKey(0)
    ...
    cnt, new = cv2.findContours(c_edge, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)[-2:]
